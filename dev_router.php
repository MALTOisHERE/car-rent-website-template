...
if($decoded===''||$decoded==='/'){require __DIR__.'/site/index.php';return;}
...
if(preg_match('#^/([A-Za-z0-9_-]+\.php)$#',$decoded,$m)){$siteFile=__DIR__.DIRECTORY_SEPARATOR.'site'.DIRECTORY_SEPARATOR.$m[1];if(is_file($siteFile)){require $siteFile;return;}}
