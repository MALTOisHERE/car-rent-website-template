...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        ...
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            ...
            <li style="text-decoration: underline;" class="breadcrumb-item active text-white">Contact</li>
        </ol>
    </div>
</div>
<!-- Header End -->
...
<div class="container-fluid contact py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize text-secondary mb-3">Contact Us</h1>
            <p class="mb-0">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a class="text-secondary fw-bold" href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
        </div>
        <div class="row g-5">
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="contact-add-item p-4">
                            <div style="background-color: #011468;" class="contact-icon mb-4">
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                <div style="background-color: #011468;" class=" p-5 rounded">
                    <h4 class="text-white mb-4">Send Your Message</h4>
                    <form>
                        <div class="row g-4">
                ...
                <div class="p-5 bg-light rounded">
                    <div class="bg-white rounded p-4 mb-4">
                        ...
                        <div class="d-flex align-items-center flex-shrink-0 mb-3">
                            <p class="mb-0 text-dark me-2">Address:</p><i class="fas fa-map-marker-alt text-secondary me-2"></i>
                            <p class="mb-0">123 Street New York.USA</p>
                        </div>
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-dark me-2">Telephone:</p><i class="fa fa-phone-alt text-secondary me-2"></i>
                            <p class="mb-0">(+012) 3456 7890</p>
                        </div>
                    </div>
                    <div class="bg-white rounded p-4 mb-4">
