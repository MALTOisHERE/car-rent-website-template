<style>
    ...
    footer .btn:hover {
        ...
        /* Optional: Adjust border if desired */
    }

    /* Change all link hover effects */
    a:hover,
    .dropdown-item:hover {
    ...
    /* Change social media button hover effects */
    .btn-md-square:hover {
        background-color: white !important;
    }
        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Our Fleet</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Special Offers</a>
