...
try{
    ...
    $args=$command['args'];$value=match($command['operation']){'create'=>contractCreateFromReservation($args),'issue'=>contractIssue($args),'cancel'=>contractCancel($args),'acknowledge'=>contractRecordAcknowledgement($args),default=>throw new InvalidArgumentException('operation')};
