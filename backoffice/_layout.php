...
function backofficeHeader($title, $active = '')
{
    ...
    <link rel="stylesheet" href="assets/app.css"><script src="assets/app.js" defer></script></head><body data-table-label="<?= e(t('shell.data_table')) ?>">
    ...
    <div class="app-shell">
      ...
      <aside class="sidebar" id="app-sidebar" aria-label="<?= e(t('shell.primary_navigation')) ?>" data-sidebar>
        <div class="sidebar-header"><a class="product-mark" href="index.php"><span class="product-logo" aria-hidden="true">R</span><span><strong><?= e(appConfig('name')) ?></strong><small><?= e(t('shell.agency_operations')) ?></small></span></a><button class="icon-button sidebar-close" type="button" data-sidebar-close aria-label="<?= e(t('shell.close_navigation')) ?>">&times;</button></div>
      ...
      <div class="app-content">
        <header class="topbar">
          <div class="topbar-leading"><button class="icon-button mobile-menu-button" type="button" data-sidebar-open aria-expanded="false" aria-controls="app-sidebar" aria-label="<?= e(t('shell.open_navigation')) ?>"><span aria-hidden="true">&#9776;</span></button><div><strong><?= e($title) ?></strong><small><?= e($agencyContext) ?></small></div></div>
