...
<td><a class="detail-link" href="invoice_detail.php?id=<?=e($invoice['id'])?>"><?=isolatedValue($invoice['invoice_number']?:t('status.draft'),'reference-value')?></a></td><td><?=e($invoice['company_name']?:$invoice['first_name'].' '.$invoice['last_name'])?></td><td><?=isolatedValue($invoice['reference'],'reference-value')?></td><td><?=formattedDateTime($invoice['issued_at'])?></td>
