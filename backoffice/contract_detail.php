...
</dl></section><section class="card"><div class="section-card-header"><h2><?=navigationIcon('rentals')?><?=e(t('section.rental_summary'))?></h2></div><p><strong><?=e(t('field.customer'))?>:</strong> <?=e($contract['first_name'].' '.$contract['last_name'])?></p><p><strong><?=e(t('field.vehicle'))?>:</strong> <?=e(trim($contract['brand'].' '.$contract['model']))?> <?=isolatedValue($contract['registration_number'],'registration-value')?></p><p><strong><?=e(t('field.period'))?>:</strong> <?=formattedDateTime($contract['pickup_at'])?> — <?=formattedDateTime($contract['return_at'])?></p><p><strong><?=e(t('field.total'))?>:</strong> <?=money($contract['total_amount'],$contract['currency'])?></p></section></div>
