...
function rolePermissions()
{
    return [
        ROLE_OWNER => ['*'],
        ROLE_AGENCY_MANAGER => ['dashboard.view', 'agencies.view', 'users.manage', 'customers.manage', 'customers.lifecycle', 'vehicles.manage', 'vehicle_damages.view', 'vehicle_damages.create', 'vehicle_damages.resolve', 'reservations.manage', 'reservations.lifecycle', 'reservations.commercial_override', 'contract.view', 'contract.create', 'contract.issue', 'contract.cancel', 'contract.acknowledge_customer', 'contract.acknowledge_agency', 'contract.sign', 'contracts.manage', 'rental.checkout', 'rental.checkin', 'payments.manage', 'payments.adjust', 'payments.excess', 'deposits.manage', 'invoices.manage', 'expenses.manage', 'expenses.decide', 'cash.manage', 'finance.evidence.view', 'inspections.manage', 'inspection_photos.view', 'inspection_photos.upload', 'inspection_photos.archive', 'maintenance.manage', 'pricing.manage', 'reports.view'],
        ROLE_RENTAL_AGENT => ['dashboard.view', 'customers.manage', 'vehicles.view', 'reservations.manage', 'contract.view', 'contract.create', 'contract.issue', 'contract.acknowledge_customer', 'contract.acknowledge_agency', 'contracts.manage', 'rental.checkout', 'rental.checkin', 'payments.create', 'inspections.manage', 'inspection_photos.view', 'inspection_photos.upload'],
        ...
        ROLE_FLEET_AGENT => ['dashboard.view', 'vehicles.manage', 'vehicle_damages.view', 'vehicle_damages.create', 'vehicle_damages.resolve', 'inspections.manage', 'inspection_photos.view', 'inspection_photos.upload', 'maintenance.manage', 'vehicle_documents.manage'],
