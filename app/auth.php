...
function rolePermissions()
{
    return [
        ...
        ROLE_RENTAL_AGENT => ['dashboard.view', 'customers.manage', 'vehicles.view', 'reservations.manage', 'contract.view', 'contract.create', 'contract.issue', 'contract.acknowledge_customer', 'contract.acknowledge_agency', 'contracts.manage', 'payments.create', 'inspections.manage'],
