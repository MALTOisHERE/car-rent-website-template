...
?>
<!doctype html><html lang="<?= e(language()) ?>" dir="<?= language() === 'ar' ? 'rtl' : 'ltr' ?>"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?= e(t('auth.forgot_password_title')) ?></title><link rel="icon" href="../backoffice/assets/img/aurevo-mark.png"><link rel="stylesheet" href="../backoffice/assets/app.css?v=<?= e(assetVersion('backoffice/assets/app.css')) ?>"></head><body class="auth-page"><main class="auth-card"><h1><?= e(t('auth.forgot_password_title')) ?></h1>
